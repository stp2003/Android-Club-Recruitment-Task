...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean checkIfValidAndRead() {
        ...
        for (int i = 0; i < layoutList.getChildCount(); i++) {
            View studentView = layoutList.getChildAt(i);

            EditText editTextName = (EditText) studentView.findViewById(R.id.edit_student_name);
            AppCompatSpinner studentDropDown = (AppCompatSpinner) studentView.findViewById(R.id.spinner_branch);
            ...
            if (studentDropDown.getSelectedItemPosition() != 0) {
                student.setBranchName(branchList.get(studentDropDown.getSelectedItemPosition()));
            } else {
                result = false;
                break;
            }
    ...
    private void addView() {
        ...
        AppCompatSpinner spinnerBranch = (AppCompatSpinner) studentView.findViewById(R.id.spinner_branch);
        ImageView imageClose = (ImageView) studentView.findViewById(R.id.image_delete);

        ArrayAdapter arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_item, branchList);
